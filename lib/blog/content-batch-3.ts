...
export const BLOG_POSTS_BATCH_3: BlogPost[] = [
  {
    ...
    category: 'PSRAS Prep',
    title: 'PSRAS Exam Format Explained (2026)',
    h1: 'PSRAS Exam Format Explained (2026)',
    description:
      'How the PSRAS is structured for police station representatives: the written exam, the Critical Incidents Test, the portfolio, and how to prepare.',
    keywords: [
      'psras exam format',
      'PSRAS pass mark',
      'PSRAS assessment 2026',
    ...
    heroImage: blogHeroImage(
      ...
      'PSRAS exam format explained for police station representative candidates in 2026',
    ),
    relatedSlugs: [
    ...
    sections: [
      {
        heading: 'What the PSRAS is and why its structure matters',
        paragraphs: [
      ...
      {
        heading: 'The written knowledge assessment',
        paragraphs: [
      ...
      {
        heading: 'The Critical Incidents Test (CIT)',
        paragraphs: [
      ...
      {
        heading: 'The supervised portfolio',
        paragraphs: [
      ...
      {
        heading: 'How to prepare across all three components',
        paragraphs: [
  ...
  },
  {
    ...
    category: 'CIT',
    title: 'How to Pass the Critical Incidents Test (CIT)',
    h1: 'How to Pass the Critical Incidents Test (CIT)',
    description:
      'A structured method for the PSRAS Critical Incidents Test: spot the issues, prioritise consultation, and give a defensible decision trail.',
    keywords: [
      'critical incidents test',
      'CIT PSRAS',
      'four-step framework',
      'police station scenario practice',
      'PSRAS assessment',
      'PACE Code C scenario',
    ],
    summary:
    ...
    heroImage: blogHeroImage(
      'how-to-pass-critical-incidents-test',
      'Candidate working through a structured method for the PSRAS Critical Incidents Test',
    ),
    relatedSlugs: [
    ...
    sections: [
      {
        heading: 'What the CIT really assesses',
        paragraphs: [
      ...
      {
        heading: 'Practice tips that build CIT performance',
        paragraphs: [
      ...
      {
        heading: 'Bringing it together on assessment day',
        paragraphs: [
  ...
  },
  {
    ...
    category: 'PSRAS Prep',
    title: 'Free PSRAS Practice Questions (Sample Set)',
    h1: 'Free PSRAS Practice Questions (Sample Set)',
    description:
      'Try a free set of PSRAS-style practice questions covering PACE Code C, the caution, detention and vulnerable suspects — with worked explanations.',
    keywords: [
      'psras practice questions',
      'PSRAS sample questions',
      'PACE Code C MCQ',
      'free PSRAS test',
      'police station representative exam practice',
    ...
    sections: [
      {
        heading: 'Why timed practice lifts your score fastest',
        paragraphs: [
      ...
      {
        heading: 'Worked sample questions with explanations',
        paragraphs: [
      ...
      {
        heading: 'How to use the sample for real improvement',
        paragraphs: [
      ...
      {
        heading: 'Next steps and important note',
        paragraphs: [
